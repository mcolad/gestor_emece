...
<?PHP
	...
	list($rowp) = paginador($select, $from, $where, $order, $var, 5);
?>
    </div>
</div>	
  	<?PHP
	...
	<div class="card">
        <div class='card-header '>
                <div class="row">
                    <div class='col-auto'>		
                            <button class='btn btn-admin btn-sm' onclick="window.location.href='index.php?editar=1&play=<?PHP echo $play; ?>&filtro_tag=<?PHP echo $filtro_tag; ?>&id=<?PHP echo $rowp[$countrow]["id_apli_".strtolower($apli)] ?>'">EDITAR</button>
        ...
        <div class="card-body ">		
                ...
                <div class="row"><?PHP if(file_exists('listar_local.php')){ include('listar_local.php'); } ?> </div>
        </div>
