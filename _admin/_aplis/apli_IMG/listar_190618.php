	...
	<div class="card">
        <div class='card-header'>
            ...
            <div style="float:right">
                <div style="float:left" id='star<?PHP echo $rowp[$countrow]['id_apli_img'] ?>'>
                    <?PHP if($rowp[$countrow]['estado'] == '3'){ $checked = 'checked="checked"'; $flag = '';  } else { $checked = ''; $flag = '1'; }  ?>
                    <input <?PHP echo $checked; ?>  title='IMG destacado' type='checkbox' class='chk star' onclick="javascript:recibeid('../../gestion/destacado.php', 'tipo=IMG&id_tipo=<?PHP echo $rowp[$countrow]['id_apli_img']; ?>&id_apli=<?PHP echo $_GET['id_apli']; ?>&flag=<?PHP echo $flag; ?>', '', 'div_null')" /><div id='div_null'></div>
                </div>
