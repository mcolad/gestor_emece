...
?>
	...
	<?PHP
     ...
     {
     ?>
          <button class='btn btn-admin btn-sm modalButton' data-toggle='modal' data-src='sql.php?apli=<?PHP echo $apli ?>&id=<?PHP echo $id ?>' data-width=100% data-target='#myModal'><?PHP svg('svgadmin/database.svg', '15', '15') ?></span> SQL</button>
          <button class='btn btn-admin btn-sm' onclick="window.location.href='../../__aplis/<?PHP echo "apli_".$titulo ?>/'"><span><?PHP svg('svgadmin/external-link-alt.svg', '15', '15') ?></span> IR</button>
     <?PHP
     }
     ?>

    	<form name="formu" action="index.php?id=<?PHP echo $id; ?>&play=<?PHP echo $play ?>&confirma=1" method="post">
        <div class="form-group">
            <div class="row">
                    ...
                    <div class="col-10">
                        <div class="row">
                            ...
                            <div class="col-6">
                                            ...
                                            <input <?PHP echo $disable ?> class='form-control' name='titulo' value='<?PHP  echo $titulo; ?>' type='text'/>
                            </div>    
                            <div class="col-12">
                    ...
                    <div class="col-2">
                            <div class="row">
                                <div class="col-12">
                                                ...
                                                <?PHP if($publicar == 1){ $checked = 'checked="checked"'; } else { $checked = ''; } ?>
                                                <input id="switch-info" name="publicar" value="1" <?PHP echo $checked ?>  type="checkbox">
                                ...
                                <div class="col-12">
                                                ...
                                                <?PHP if($adjuntos == 1){ $checked = 'checked="checked"'; } else { $checked = ''; } ?>
                                                <input id="switch-info2" name="adjuntos" value="1" <?PHP echo $checked ?>  type="checkbox">
                                ...
                                <div class="col-12">
                                                ...
                                                <?PHP if($fecha_sino == 1){ $checked = 'checked="checked"'; } else { $checked = ''; } ?>
                                                <input id="switch-info3" name="fecha_sino" value="1" <?PHP echo $checked ?>  type="checkbox">
                                                ...
                                                <select name="menu_admin">
                                                	<?PHP
														...
														while($row_menu = mysqli_fetch_array($result_menu))
														{
															...
															{  
															?>
															<option <?PHP echo $select; ?>  value="<?PHP echo $row_menu['id_apli_menu'] ?>"><?PHP echo $row_menu['titulo'] ?></option>
															<?PHP
                                                                           }
														}
													?>
                    ...
                    <div class='col-12 text-center mt-3' style="position:absolute; bottom:-50px;">
                        ...
                        <button class='btn btn-danger' value="Cancelar" type="reset" onClick="location.href='?play=<?PHP echo $play ?>'" />Cancelar</button>
                    </div>
           </div>
        </div>
 		</form>
        ...
        <div class="row">
            <div class='col-md-12'>
           		<?PHP  tagdeaplis($apli, $id);?>	
            </div>
        </div>
        
        <div class="row">
            <div class='col-md-12'>
           		<?PHP tagdehijos($apli, $id);?>	
            </div>
        </div>        
