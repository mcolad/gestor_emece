	...
	<div class="card">
        <div class='card-header'>
            <div style="float:left">		
                    <button class='btn btn-admin btn-sm' onclick="window.location.href='index.php?editar=1&play=<?PHP echo $play; ?>&id=<?PHP echo $rowp[$countrow]["id_apli_".strtolower($apli)] ?>'">EDITAR</button>
