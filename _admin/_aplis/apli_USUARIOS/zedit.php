...
<div class='col-lg-12 text-right'>
    <button class='btn btn-admin btn-sm modalButton' data-toggle='modal' data-src='<?PHP echo $path; ?>/_admin/gestion/apli_img/index.php?menu_adj=1&id_apli=<?PHP echo $id; ?>&apli_padre=<?PHP echo $apli; ?>' data-width=100% data-target='#myModal'><i class="fa fa-paperclip"></i>  Adjuntos</button>
</div>
<?PHP } ?>
