            <div class='col-md-12 text-right mt-3'>
                 <button class='btn btn-success btn-sm' onclick="window.location.href='index.php?editar=1&play=<?PHP echo $play; ?>&id_apli_tagdetag=<?PHP echo $_GET['id_apli_tagdetag'] ?>'" type="submit"/>Carga Manual</button>
            </div>

            <form name="formu" action="index.php?csv_insert=1&play=<?PHP echo $play ?>&id_apli_tagdetag=<?PHP echo $_GET['id_apli_tagdetag'] ?>&confirma=1" method="post" enctype="multipart/form-data">
