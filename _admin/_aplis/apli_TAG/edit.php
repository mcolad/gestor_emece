...
<div class="form-group">
    <div class="row">
            ...
            <div class='col-md-12'>
				<?PHP if($titulo != ''){ ?><label>Nombre del TAG</label><br /><input class='form-control' name='titulo' value='<?PHP  echo $titulo; ?>' type='text'/><?PHP } 
				else{ ?><label>Nombre del TAG <font color="#666666" size="-2">nombre[TAB]obs / Para más de un tag, ubicar uno debajo del otro</font></label><br /><textarea class='form-control' name='titulo'><?PHP  echo $titulo; ?></textarea><?PHP } ?>
            </div> 
				<?PHP if($titulo != ''){ ?>
               <div class='col-md-12'>
