...
{
	// imprimime los tag (activos) discriminando por tagdetag
...
?>
<?PHP
function devuelve_tag($id_apli_tagdetag, $id_apli_tag)
{
	// igul que imprime_tag ero en vez de salir con echo, devuelve el valor;
