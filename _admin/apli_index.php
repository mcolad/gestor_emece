				           ...
				           <?PHP 
								...
								elseif($menu == 'menu_adjuntos') 
								{
									...
									{ 
										...
										?><button class="btn <?PHP echo $active_class_adjunto; ?>" <?PHP echo $active_menu_adjunto; ?> onClick="window.location.href='../apli_<?PHP echo $valor?>/?id_apli=<?PHP echo $_GET['id_apli'] ?>&apli_padre=<?PHP echo $_GET['apli_padre'] ?>'" type="button" id="sidebarCollapse"><?PHP echo $valor ?> <div class="badge badge-light"><?PHP echo $cantidad_nro ?></div></button> <?PHP
									}
								...
								elseif($menu == 'menu_tag') 
								{
									...
									{ 
										...
										?><button <?PHP echo $active_menu_adjunto; ?> onClick="window.location.href='../apli_<?PHP echo $valor?>/?id_apli=<?PHP echo $_GET['id_apli'] ?>&apli_padre=<?PHP echo $_GET['apli_padre'] ?>'" type="button" id="sidebarCollapse" class="btn btn_admin"><?PHP echo $valor?></button><?PHP
									}
								}
								elseif($menu == 'Menu') 
								{
