...
<input class="form-control" aria-label="Small" type="text" name="valor" value="<?PHP echo $_GET['valor']; ?>">
<input class="form-control" aria-label="Small" type="hidden" name="Field" value="<?PHP echo $_GET['Field']; ?>">
<input class="form-control" aria-label="Small" type="hidden" name="apli" value="<?PHP echo $_GET['apli']; ?>">
<input class="form-control" aria-label="Small" type="hidden" name="id" value="<?PHP echo $_GET['id']; ?>">
</div>
<div style='float:right; width:20%; text-align:right'><a style='cursor:pointer;' onClick="recibeid('ver_edit.php', 'insert=1&valor='+formu.valor.value+'&Field='+formu.Field.value+'&apli='+formu.apli.value+'&id='+formu.id.value, '', 'div_<?PHP echo $_GET['Field'] ?>');">
<?PHP
