						...
						<div id="registro">
							<h3 class="text-center text-info pt-5">Modificar Clave </h3>
								<div id="login-row" class="row justify-content-center align-items-center">
                                        <?PHP echo "Clave modificada exitosamente"; ?>
								</div>
								<div class="row justify-content-center align-items-center p-4">
                                        <?PHP echo svg('svgadmin/laugh-wink.svg', '400', '400', '#17a2b8'); ?>
								</div>
                              </div>
                         </div>
								...
								<div id="login-row" class="row justify-content-center align-items-center">
									<div id="login-column" class="col-md-6">
										<div class="login-box col-md-12">
											<form id="login-form" name="formu" action="?email_us=<?PHP echo $_GET['email_us']?>" class="form" method="post">
												<div class="form-group">
													<label class="text-info">Correo electrónico</label><br>
													<?PHP echo $_GET['email_us']?>
												<div class="form-group">
