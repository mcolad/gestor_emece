...
<a type='button' class='btn btn-success btn-sm' href="backup/<?PHP echo $backup_file_name ?>" style="width:100%">Descargar Backup</a>
...
?>
    ...
    <a  href="backup/<?PHP echo $backup_file_name; ?>" class='btn btn-info btn-sm' style="width:100%"> Descargar</a>
