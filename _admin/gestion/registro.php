...
if($bd == 'apli_USUARIOS'){ if(empty($_SESSION['acc_adm_us'])){ $email = ''; $msj_err = ''; $instancia = 'loguearse'; } }
	...
	{ 
		...
		{ 
			if($bd == 'apli_USUARIOS')
			{
				...
				$_SESSION['id_apli_usuarios'] = $row['id_apli_usuarios']; 			
			}
...
//		mysqli_query($cnx, "UPDATE $bd SET nick = '".$nick."' WHERE id_".strtolower($bd)." = '".$id."';");
		...
		{ mensaje('Registro Exitoso!', 'Inicie el proceso de <b>logueo</b> con su usuario y clave'); die; }
      ...
      <div class="col-xl-10 col-lg-12 col-md-9" style="opacity:0.8;">
               ...
               <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <!-- Nested Row within Card Body -->
                         <div class="row">
                          	<div class="col-lg-6 d-none d-lg-block"><img class="img-fluid"  src="/<?PHP echo $abs; ?>_admin/_img/logueo.png" /></div>
              				<div class="col-lg-6">
							...
							Si es la primera vez que ingresás<br>primero tenés que realizar el 
                                   ...
                                   <div class="text-center text-danger"><?PHP echo $msj_err; ?></div>
                                        <form class="user" action="?" method="post">
                                        <input type="hidden" value="loguear" name="instancia" />
                                        <div class="form-group">
                                        <input type="email" required name="email" value="<?PHP echo $email; ?>" placeholder="ingrese correo" class="form-control">
                                        </div>
                                        <div class="form-group">
                                   ...
                                   <?PHP if($email_smtp != ''){?><div class="text-right"><a style="width:100%" href="?instancia=recupero" class="text-info">Ir a Recuperar Clave</a></div><?PHP } ?>
...
<body style=" background:url(/<?PHP echo $abs; ?>_admin/_img/fondo.jpg); background-size: cover; background-repeat:no-repeat">
                    ...
                    <!-- Nested Row within Card Body -->
                         <div class="row">
                              ...
                              <div class="col-lg-6">
								   ...
								   <div>Solo se puede registrar, si es <b>Docente Responsable de un Curso de Posgrado Profesional o Programa de Posgrado Profesional.</b><br>
								   Si Ud. cumple con esta condición, debe ingresar con el correo electrónico que asignó como responsable</div>
                                   </div>
                                   <div class="text-center text-danger"><?PHP echo $msj_err; ?></div>
                                        <form class="user" action="?" method="post">
								<input type="hidden" value="registrar" name="instancia" />
                                        <div class="form-group">
                                        <input type="email" required name="email" placeholder="ingrese correo" value='<?PHP if(isset($_POST['email'])){ echo $_POST['email']; }?>' class="form-control">
                                        </div>
                                        <div class="form-group">
                                   ...
                                   <div class="text-right"><a style="width:100%" href="?registro=loguearse" class="text-info">No registrarme y Volver al Logueo</a></div>
                                   <?PHP if($email_smtp != ''){?><div class="text-right"><a style="width:100%" href="?instancia=recupero" class="text-info">Ir a Recuperar Clave</a></div><?PHP } ?>
                         ...
                         <div class="row">
                              ...
                              <div class="col-lg-6">
								...
								<input type="hidden" value="recuperar" name="instancia" />
                                   ...
                                   <div class="text-right"><a style="width:100%" href="?registro=loguearse" class="text-info">Ir a <b>Logueo</b></a></div>
                                   <div class="text-right"><a style="width:100%" href="?instancia=registro" class="text-info">Ir a <b>Registro</b></a></div>
