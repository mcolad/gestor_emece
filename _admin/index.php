    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <nav style='margin-bottom:10px'>
                	<div class="row ml-2">
					        <button type="button" id="sidebarCollapse" class="btn btn_admin"><?PHP svg('svgadmin/bars.svg', 20, 20, '#667788') ?>  </button> <h4 class="pl-2">ADMINISTRADOR DE CONTENIDOS</h4>
                	</div>
            </nav>
          ...
          <div class="col-lg-12">
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-6 pt-1 text-right">
                                   ...
                                   ?>
                                   <?PHP if(@$row_analytics['audiencia'] != '') {?> <a href='estadistica.php?analytics=audiencia'>Audiencia</a>&nbsp;&nbsp;&nbsp;<?PHP }?>
                                   <?PHP if(@$row_analytics['comportamiento'] != '') {?> <a href='estadistica.php?analytics=adquisicion'>Adquisiciones</a>&nbsp;&nbsp;&nbsp;<?PHP }?>
                                   <?PHP if(@$row_analytics['adquisicion'] != '') {?> <a href='estadistica.php?analytics=comportamiento'>Comportamiento</a>&nbsp;&nbsp;&nbsp;<?PHP }?>
                                   </h5>
                              </div>
                         </div>
            ...
            <div class="row">
            	<div class="col-md-4 col-xs-12 bg-white p-4  border rounded shadow-sm">
                    ...
                    <thead style="background:#9283BE" class=" text-light"><tr>
                        <th>Publicaciones</th><th align="center" style="text-align:center"><?PHP svg('svgadmin/laugh.svg', 30, 30, 'white'); ?></th><th align="center" style="text-align:center"><?PHP svg('svgadmin/meh.svg', 30, 30, 'white'); ?></th><th align="center" style="text-align:center"><?PHP svg('svgadmin/dizzy.svg', 30, 30, 'white'); ?></th><th></th></tr></thead>
					<?PHP 
                ...
                <div class="col-md-4 col-xs-12 bg-white p-4  border rounded shadow-sm">
                    <table class="table table-sm table-striped">
                    <thead style="background:#50B8B1" class=" text-light"><tr><th>Archivos disponibles</th><th align="center" style="text-align:center"><?PHP svg('svgadmin/laugh.svg', 30, 30, 'white'); ?></th><th align="center" style="text-align:center"><?PHP svg('svgadmin/meh.svg', 30, 30, 'white'); ?></th><th align="center" style="text-align:center"><?PHP svg('svgadmin/dizzy.svg', 30, 30, 'white'); ?></th><th></th></tr></tr></thead>
					<?PHP 
                ...
                <div class="col-md-4 col-xs-12 bg-white p-4  border rounded shadow-sm">
                    <table class="table table-sm table-striped">
                    <thead style="background: #D784A7" class=" text-light"><tr><th>Herramientas de gestión</th><th align="center" style="text-align:center"><?PHP svg('svgadmin/laugh.svg', 30, 30, 'white'); ?></th><th align="center" style="text-align:center"><?PHP svg('svgadmin/meh.svg', 30, 30, 'white'); ?></th><th align="center" style="text-align:center"><?PHP svg('svgadmin/dizzy.svg', 30, 30, 'white'); ?></th><th></th></tr></tr></thead>
					<?PHP
