...
$allow_delete = false; // Establezca en falso para deshabilitar el botón Eliminar y eliminar la solicitud POST.
$allow_upload = false; // Establecer en verdadero para permitir cargar archivos
$allow_create_folder = false; // Establecer en falso para deshabilitar la creación de carpetas
$allow_direct_link = false; // Establecer en falso para permitir solo descargas y no enlaces directos
$allow_show_folders = true; // Establecer en falso para ocultar todos los subdirectorios

$disallowed_extensions = ['bat'];  // debe ser una matriz. Extensiones no permitidas para cargar
$hidden_extensions = ['bat']; // debe ser una matriz de extensiones de archivo en minúsculas. Extensiones ocultas en el índice del directorio

$PASSWORD = 'mceTM72';  // Establezca la contraseña para acceder al administrador de archivos ... (opcional)
...
<footer>Manejador de Archivos <a href="https://www.configuroweb.com/">ConfiguroWeb</a></footer>
</body>
</html>
