                           ...
                           if (is_dir($ruta)) {
                              if ($dh = opendir($ruta)) {
                                 while (($file = readdir($dh)) !== false) {
                                     ...
                                     {
                                        ?>
                                        <div id='<?PHP echo $file ?>' class='col-2 text-center p-2'>
                                        <img height='50px;' src="<?PHP echo substr($ruta, 2).$file ?>"><br /><font size="-2"><?PHP echo substr($file, 0, -4) ?> 
                                        <a href="javascript:recibeid('delete.php', 'borrar=<?PHP echo substr($ruta, 2).$file ?>', '', '<?PHP echo $file ?>')">[x]</a></font>
                                        </div>
                                        <?PHP
                                     }
                                    ...
                                    {
                                       ?>
                                       <div class='col-12 p-2 text-center' style='background-color: #FFC;'><strong><?PHP echo strtoupper($file) ?></strong></div>
                                       <?PHP
